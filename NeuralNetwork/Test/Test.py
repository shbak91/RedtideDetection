...
# Load Data
D = pd.read_csv('Dataset_Test_2019_0622_s.csv')

x_data = D[['nlw1', 'nlw2', 'nlw3', 'nlw4', 'nlw5', 'nlw6', 'nlw7', 'nlw8']]

x_data2 = D[['nlw1', 'nlw2', 'nlw3', 'nlw4', 'nlw5', 'nlw6', 'nlw7', 'nlw8', 'Class1', 'Class2', 'Class3']]
...
np.savetxt('Detection_Result_Dataset_Test.csv', r,
           header='nlw1,nlw2,nlw3,nlw4,nlw5,nlw6,nlw7,nlw8,Class1,Class2,Class3,P_Class1,P_Class2,P_Class3,PredictionResult',
           delimiter=',',
           comments='',
           fmt='%2.5f')
